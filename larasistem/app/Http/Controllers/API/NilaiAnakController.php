...
class NilaiAnakController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($anak as $a) {
            ...
            foreach ($a->lokal as $lokal) {
                ...
                $data['label']=$lokal->kelas->kelas." ".$lokal->nama." Semester ".$lokal->semester;
                $lokalSiswa[$a->id][]=$data;
            }
        }
        return response()->json(['anak'=>$anak,'lokalSiswa'=>$lokalSiswa],200);
    }
    ...
    public function buildRekapAll($id_siswa,$idlokal)
    {
        ...
        //return dd($data);
        return compact('data','listLokal','mapelDariLokal','id_siswa');
    }
    public function buildRekap($id_siswa,$idlokal,$idmapel)
    {
        ...
        return compact('listLokal','mapelDariLokal','nilai','rata','dataChart','namaKelas','mapel','idlokal','idmapel','id_siswa');
    }
   public function rapor($id, $id_lokal)
   {
       ...
       return response()->json(['error'=>"Anda tidak bisa melihat data siswa yang bukan anak anda"],403);
   }
