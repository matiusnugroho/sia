    ...
    <body id="minovate" class="appWrapper">
        ...
        <div id="wrap" class="animsition">
            ...
            <div class="page page-core">
                ...
                <div class="text-center"><img class="logoimg" src="{{url('/assets/images/smanpin.png')}}"><h3 class="text-light text-white"><span class="text-lightred">SIA</span>STAR</h3></div>
        ...
        ============== Vendor JavaScripts ===============
        ============================================= -->
        <script>window.jQuery || document.write('<script src="assets/js/vendor/jquery/jquery-2.1.1.js"><\/script>')</script>
