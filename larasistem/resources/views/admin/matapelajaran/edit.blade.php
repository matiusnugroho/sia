@extends('admin.index')
@section('title')- Sunting data Mata Pelajaran @endsection
...
<div class="row  border-bottom white-bg dashboard-header">
    <h2>Mata Pelajaran / <small><i class="fa fa-pencil"></i> Edit</small></h2>
</div>
<div class="wrapper wrapper-content animated fadeInUp">
    <div class="ibox">
        <div class="ibox-content">
            <div class="row m-b-sm p-md">
                {!! Form::model($mapel,['route' => ['matapelajaran.update',$mapel->id],'method'=>'patch', 'class' => 'form-horizontal']) !!}
