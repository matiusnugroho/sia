    ...
    <div class="ibox">
        <div class="ibox-content">
            ...
            {{-- {{dd($errors->messages->get('username'))}} --}}
                {!! Form::open(['route' => 'jurusan.store','method'=>'post', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="form-group @if($errors->has('ketua_jurusan')) has-error @endif">
                                    ...
                                    <div class="col-sm-4">
                                        <select data-placeholder="Pilih ketua/pembimbing jurusan" id="selectKetua" class="chosen-select form-control" name="ketua_jurusan">
                                        <option value="">Pilih ketua/pembimbing jurusan</option>
                                        @foreach($guru as $s)
