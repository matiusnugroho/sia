                ...
                <div class="ibox">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            @if($userDetail!=null)
                            <div class="row">
                                <div class="col-md-4">Nama</div><div class="col-md-8">{{$userDetail->nama}}</div>
                                <div class="col-md-4">NIP</div><div class="col-md-8">{{$userDetail->nip}}</div>
                                <div class="col-md-4">Tanggal Lahir</div><div class="col-md-8">{{$userDetail->tgl_lahir}}</div>
                            </div>
                            @else
