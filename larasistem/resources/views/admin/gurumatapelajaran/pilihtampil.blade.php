        ...
        <div class="ibox-content p-md">
            <div class="row m-b-sm p-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3"> 
                    {!!Form::select('ta',$ta,['0'=>'Pilih Tahun Ajaran'],['placeholder'=>"Tahun Ajaran",'class'=>'input-sm form-control','id'=>'selectTA'])!!}
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">Lokal</label>
                    <div class="col-sm-3"> 
                    {!!Form::select('lokal',['0'=>""],null,['class'=>'input-sm form-control','id'=>'selectLokal','placeholder'=>"Pilih Lokal"])!!}
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        selectTA.addEventListener('change',function(){setSelect(this.value,'selectLokal')});
    }
    function setSelect(id,selectTarget) {
        lokali = lokal[id];
        html="";
        lokaliSelek = document.getElementById(selectTarget);
        for(i in lokali){
            html+="<option value='"+lokali[i].id+"'>"+lokali[i].kelas.kelas+" "+lokali[i].nama+" "+lokali[i].jurusan.jurusan+"</option>";
        }
        lokaliSelek.innerHTML=html;
    }
</script>
@endsection