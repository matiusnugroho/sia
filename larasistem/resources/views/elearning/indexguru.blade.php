...
{{-- <div class="col-lg-12"> --}}
            <div class="ibox float-e-margins">                
                ...
                {!!Form::open(['route'=>['elearning.posts'],'method'=>'get','class'=>'form-horizontal'])!!}
                    ...
                    <div class="form-group">
                      <div class="col-md-6">
                        <button type="submit" class="btn btn-small btn-primary" id="editnilaisemuasubmit"><i class="fa fa-search"></i></button>
                      </div>
                    </div>
                {!!Form::close()!!}
                    </div>
